ruleset {
  ...
  DuplicateStringLiteral {
    ignoreStrings = 'numProtocol,agent,answerId,isCorrect,createdAt,tenant,origin,channel,idCustomer,team,nameUser,' +
      'idUser,/,%,companyId,customerId,originId,id,, ,config,id_tenant,tenant_name,active,name,feature_toggles,' +
      'integration,channel_data,tenants,tenantWithoutTeams,tenantByName,tenantByNameWithoutTeams'
  }
  ...
  Indentation
  LineLength {
    ignoreLineRegex = '.*log\\.(debug|info|warn|error)\\(.*\\)'
  }
